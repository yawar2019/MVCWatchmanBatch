...
namespace DatabaseFirstApproach.Controllers
{
    public class employeeDetailsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "EmpId,EmpName,EmpSalary,DeptId,Address,dob,Mobiles,Status,CreatedBy,MobileNo,Available,CreatedOn,FatherName,Location")] employeeDetail employeeDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "EmpId,EmpName,EmpSalary,DeptId,Address,dob,Mobiles,Status,CreatedBy,MobileNo,Available,CreatedOn,FatherName,Location")] employeeDetail employeeDetail)
        {
            if (ModelState.IsValid)
            {
